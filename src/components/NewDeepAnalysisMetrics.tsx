    ...
    <div className="flex flex-col w-full p-3.5 sm:p-5 gap-3.5">
      <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-3">
         ...
         <motion.div 
           ...
           className="bg-zinc-950/60 border border-zinc-800/80 rounded-xl p-3.5 hover:bg-rose-950/10 hover:border-rose-500/30 transition-all duration-200 ease-out flex flex-col justify-between cursor-pointer group shadow-xs"
         ...
         >
           <div className="flex items-center justify-between mb-2">
             <span className="text-[10px] font-bold uppercase text-zinc-400 tracking-wider font-mono flex items-center gap-1.5">
               <span className="p-1 rounded-md bg-rose-500/10 border border-rose-500/20 text-rose-400">
                 <ArrowDownRight size={11} className="group-hover:scale-110 transition-transform" />
               </span>
               Max Drawdown
             </span>
           </div>
         ...
         <motion.div 
           variants={itemVariants} 
           className="bg-zinc-950/60 border border-zinc-800/80 rounded-xl p-3.5 hover:bg-blue-950/10 hover:border-blue-500/30 transition-all duration-200 ease-out flex flex-col justify-between cursor-pointer group shadow-xs"
         ...
         <motion.div 
           variants={itemVariants} 
           className="bg-zinc-950/60 border border-zinc-800/80 rounded-xl p-3.5 hover:bg-emerald-950/10 hover:border-emerald-500/30 transition-all duration-200 ease-out flex flex-col justify-between cursor-pointer group shadow-xs"
         ...
         <motion.div 
           variants={itemVariants} 
           className="bg-zinc-950/60 border border-zinc-800/80 rounded-xl p-3.5 hover:bg-indigo-950/10 hover:border-indigo-500/30 transition-all duration-200 ease-out flex flex-col justify-between cursor-pointer group shadow-xs"
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
         ...
         <motion.div 
           variants={itemVariants} 
           className="bg-zinc-950/60 border border-zinc-800/80 rounded-xl p-3.5 hover:bg-blue-950/10 hover:border-blue-500/30 transition-all duration-200 ease-out flex items-center justify-between cursor-pointer group shadow-xs"
           onClick={() => onMetricClick && onMetricClick("avgRecoveryTrades", metrics.avgRecoveryTrades?.toFixed(1) || "0")}
         >
           <div className="flex items-center gap-2.5">
             <div className="p-2 bg-blue-500/10 border border-blue-500/20 rounded-lg group-hover:scale-105 transition-transform text-blue-400">
               <Activity size={14} />
             </div>
             <div>
         ...
         <motion.div 
           variants={itemVariants} 
           className="bg-zinc-950/60 border border-zinc-800/80 rounded-xl p-3.5 hover:bg-emerald-950/10 hover:border-emerald-500/30 transition-all duration-200 ease-out flex items-center justify-between cursor-pointer group shadow-xs"
         ...
         >
           <div className="flex items-center gap-2.5">
             <div className="p-2 bg-emerald-500/10 border border-emerald-500/20 rounded-lg group-hover:scale-105 transition-transform text-emerald-400">
               <Target size={14} />
             </div>
             <div>
               <h3 className="text-xs font-bold uppercase tracking-wider text-zinc-200 font-mono">
           ...
           <div className="flex gap-2">
              <div className="bg-zinc-900 border border-zinc-800 py-1 px-2.5 rounded-lg flex items-center gap-1.5">
