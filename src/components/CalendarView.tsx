        ...
        >
          ...
          <div className="flex items-start justify-between">
            <span className={`font-mono text-[10px] sm:text-[11px] leading-none transition-all ${
              isToday 
                ? 'bg-blue-500/15 text-blue-400 border border-blue-500/40 font-black px-1.5 py-0.5 rounded-lg shadow-xs' 
         ...
         <AnimatePresence>
           ...
           >
             <motion.div
               ...
               transition={{ duration: 0.15, ease: "easeOut" }}
               style={{ willChange: 'opacity' }}
               className="w-full max-w-4xl max-h-[85vh] flex flex-col bg-zinc-950/90 border border-zinc-800/80 rounded-2xl shadow-2xl relative overflow-hidden"
                ...
                <div className="overflow-x-auto overflow-y-auto flex-1 min-h-[300px] px-2 sm:px-4 pb-2 sm:pb-4 pt-3 bg-zinc-950/60">
                  <table className="w-full text-left border-separate sm:border-spacing-x-0 sm:border-spacing-y-1 text-[10px] sm:text-[11px] font-mono whitespace-nowrap sm:table-fixed sm:min-w-[700px] block sm:table">
                    <thead className="sticky top-0 z-20 hidden sm:table-header-group">
                      <tr className="text-[9px] text-zinc-400 uppercase tracking-widest relative after:absolute after:inset-0 after:rounded-xl after:border after:border-zinc-800/80 after:pointer-events-none">
                        ...
                        <th className="py-1.5 px-3 text-right font-mono select-none w-[16%] min-w-[95px] bg-zinc-900"><div className="flex items-center justify-end w-full"><span>Kâr/Zarar</span></div></th>
                        <th className="py-1.5 px-2 text-center font-mono select-none w-[14%] min-w-[80px] bg-zinc-900 rounded-r-xl">Platform</th>
                      </tr>
                    </thead>
